                ...
                {tips.map((tip, index) => {
                  ...
                  >
                    ...
                    {displayImageUrl && displayImageUrl.trim() !== '' ? (
                      <div className="relative w-full h-[28rem] md:h-[32rem] overflow-hidden bg-gray-800">
                        <motion.img
                          key={displayImageUrl}
                          src={displayImageUrl}
                      ...
                      <div className="relative w-full h-[28rem] md:h-[32rem] overflow-hidden bg-gradient-to-br from-gray-700 to-gray-800 flex items-center justify-center">
                    ...
                    <div className="pt-1 pb-5 px-5 flex flex-col h-full">
                      {/* Title with Star */}
