                ...
                {tips.map((tip, index) => {
                  ...
                  >
                    ...
                    {displayImageUrl && displayImageUrl.trim() !== '' ? (
                      <div className="relative w-full h-[21rem] md:h-[25rem] overflow-hidden bg-gray-800">
                        <motion.img
                          key={displayImageUrl}
                          src={displayImageUrl}
                      ...
                      <div className="relative w-full h-[21rem] md:h-[25rem] overflow-hidden bg-gradient-to-br from-gray-700 to-gray-800 flex items-center justify-center">
